...
if __name__ == '__main__':
    ...
    ap.add_argument("-i", "--data", type=str, default="data.yaml",
                    help="path to data.yaml")   #required=False,
    ap.add_argument("-n", "--name", type=str, default="Checkp/",
    ...
    ap.add_argument("-m", "--model", type=str, default="yolo_nas_s",
                    help="Model type (eg: yolo_nas_s)")  #required=False,
